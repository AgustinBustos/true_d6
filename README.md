...
Lately i have been playing with pseudorandom generators, the "pseudo" aspect is very intriguing to me, the reason is that in order to find a truly random sequence, all i could find is some usage of radioactive material; why not use 
# 

The idea comes from the econometrics concept "instrumental variable" 
